...
import { MdKeyboardDoubleArrowLeft, MdOutlineRestaurantMenu } from 'react-icons/md';
import { CiViewList } from "react-icons/ci";
import { GiCampCookingPot, GiSpellBook } from "react-icons/gi";
...
function SidebarChef() {
    ...
    const items = [
        { label: 'Konfirmasi Pesanan', icon: <CiViewList color='#fff' />, path: '/Chef/ConfirmOrders' },
