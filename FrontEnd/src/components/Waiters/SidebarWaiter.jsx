...
function SidebarWaiter() {
    ...
    const items = [
        { label: 'Dashboard', icon: <MdDashboard color='#fff' />, path: '/Waiter/Dashboard' },
        { label: 'Add New Order', icon: <MdOutlineRestaurantMenu color='#fff' />, path: '/Waiter/NewOrder' },
        { label: 'List Meja', icon: <MdTableBar color='#fff' />, path: '/Waiter/List-meja' },
        { label: 'Pesanan Saya', icon: <LuClipboardList color='#fff' />, path: '/Waiter/PesananSaya' },
        { label: 'Selesai Dimasak', icon: <IoFastFood color='#fff' />, path: '/Waiter/PesananSelesaiDimasak' },
    ];
