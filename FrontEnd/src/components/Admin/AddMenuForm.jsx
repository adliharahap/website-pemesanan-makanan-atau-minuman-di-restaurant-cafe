...
const AddMenuForm = () => {
  ...
  const handleAddMenuSubmit = async(e) => {
    ...
    try {
        const addMenuData = {namaMenu, deskripsi, harga, imageUrl, type, stock};
        const token = localStorage.getItem('token');

        const response = await axios.post('http://localhost:3001/api/users/admin/add-menu', addMenuData, {
            headers: {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      >
        ...
        <p className="text-gray-600 text-sm mb-6 text-center font-poppins">
          Tambahkan detail menu makanan atau minuman yang ingin kamu input.
        </p>
