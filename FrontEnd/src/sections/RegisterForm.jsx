    ...
    return (
        <form className="w-full h-full px-6" onSubmit={handleRegisterSubmit} method="POST">
            <div className="w-full flex flex-col py-3">
                ...
                <Input type="text" id="username" name="username" inputValue={usernameInput} setInputValue={setUsernameInput} placeholder="Masukan username kamu" />
                <br />
            </div>
            <div className="w-full flex flex-col pb-3">
                <label htmlFor="email" className="font-Poppins text-md font-medium">Email</label>
                <Input type="email" id="email" name="email" placeholder="Masukan email kamu" inputValue={emailInput} setInputValue={setEmailInput} />
                <br />
            </div>
            <div className="w-full flex flex-col relative pb-3">
                ...
                <Input type="password" id="password" name="password" placeholder="Masukan password kamu" inputValue={PasswordInput} setInputValue={setPasswordInput} />
                {isShowPassword ? (
            ...
            <div className="w-full flex flex-col relative">
                ...
                <Input type="Password" id="confirmPassword" name="confirmPassword" placeholder="confirm password kamu" inputValue={confirmPasswordInput} setInputValue={setConfirmPasswordInput}/>
